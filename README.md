...
11. I set up a couple styling to allow you to embed multiple images and video easily and become responsive for mobile view. See the [demo]([leea12.github.io](https://leea12.github.io/)) project. You can also add code blocks, blockquote, and tables. 
